...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net bidirec_0_bidir [get_bd_ports bidir_4] [get_bd_pins bidirec_0/bidir]
  ...
  connect_bd_net -net bidirec_11_bidir [get_bd_ports bidir_0] [get_bd_pins bidirec_11/bidir]
  ...
  connect_bd_net -net bidirec_14_bidir [get_bd_ports bidir_26] [get_bd_pins bidirec_14/bidir]
  ...
  connect_bd_net -net bidirec_16_bidir [get_bd_ports bidir_20] [get_bd_pins bidirec_16/bidir]
  ...
  connect_bd_net -net bidirec_19_bidir [get_bd_ports bidir_8] [get_bd_pins bidirec_19/bidir]
  ...
  connect_bd_net -net bidirec_24_bidir [get_bd_ports bidir_14] [get_bd_pins bidirec_24/bidir]
  ...
  connect_bd_net -net bidirec_30_bidir [get_bd_ports bidir_31] [get_bd_pins bidirec_30/bidir]
  connect_bd_net -net bidirec_30_outp [get_bd_pins bidirec_30/outp] [get_bd_pins gpio_wrapper_0/outp_30]
  connect_bd_net -net bidirec_31_bidir [get_bd_ports bidir_11] [get_bd_pins bidirec_31/bidir]
  ...
  connect_bd_net -net bidirec_5_bidir [get_bd_ports bidir_23] [get_bd_pins bidirec_5/bidir]
  connect_bd_net -net bidirec_5_outp [get_bd_pins bidirec_5/outp] [get_bd_pins gpio_wrapper_0/outp_5]
  connect_bd_net -net bidirec_6_bidir [get_bd_ports bidir_19] [get_bd_pins bidirec_6/bidir]
  connect_bd_net -net bidirec_6_outp [get_bd_pins bidirec_6/outp] [get_bd_pins gpio_wrapper_0/outp_6]
  connect_bd_net -net bidirec_7_bidir [get_bd_ports bidir_16] [get_bd_pins bidirec_7/bidir]
  connect_bd_net -net bidirec_7_outp [get_bd_pins bidirec_7/outp] [get_bd_pins gpio_wrapper_0/outp_7]
  connect_bd_net -net bidirec_8_bidir [get_bd_ports bidir_13] [get_bd_pins bidirec_8/bidir]
